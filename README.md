...
- The peer sees only what the argument turns on — no repo, no shell, no session history. There's no
  ...
  "background on the project", file dumps. A peer reading 300k of unrelated context stops arguing
